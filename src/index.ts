...
const start = async () => {
  ...
  const deps: IAggDeps = {
    ...
    pauseTransferAggregator: config.get('PAUSE_TRANSFER_AGGREGATOR'),
    pauseSettlementAggregator: config.get('PAUSE_SETTLEMENT_AGGREGATOR'),
    pauseFxTransferAggregator: config.get('PAUSE_FXTRANSFER_AGGREGATOR'),
